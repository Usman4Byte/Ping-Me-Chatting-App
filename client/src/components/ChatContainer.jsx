...
const ChatContainer = () => {
  ...
  return selectedUser ? (
    <div className='h-full overflow-auto relative backdrop-blur-lg'>
      ...
      {/* chat area */}
      <div className='flex flex-col h-[calc(100%-120px)] overflow-y-auto p-3 pb-6 hide-scrollbar'>
      ...
      <div className='absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3'>
        <div className='flex-1 flex items-center bg-gray-100/12 px-3 rounded-full'>
          ...
          <input onChange={handleSendImage} type="file" id='image' accept='image/png, image/jpg, image/jpeg, image/webp' hidden />
          <label htmlFor="image">
